...
- **Details:**
  ...
  - Added the `Glitchless` tag to the Category page, starting with SSG (half-body) and Prop Fly detection; phantom hand grabs and jumping while standing on a grabbed movable object are flagged invalid.
